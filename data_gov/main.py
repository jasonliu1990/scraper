...
try:
    ...
    try:
        ...
        data_gov_corp_tax.to_csv(f'./{OUTPUT_DIR}/{corp_tax_filename}_{today_yyyymmdd}.csv', index=False)
# data_gov_director
...
try:
    ...
    try:
        ...
        data_gov_director.to_csv(f'./{OUTPUT_DIR}/{director_filename}_{today_yyyymmdd}.csv', index=False)
# data_gov_edu_org
...
try:
    ...
    data_gov_edu_org.to_csv(f'./{OUTPUT_DIR}/{gov_edu_org_filename}_{today_yyyymmdd}.csv', index=False)
# del tmp folder
path_tmp = './tmp'
try:
